...
function createMYFIWidget(params) {
  ...
  [sumInput, nameInput, innInput, phoneInput, emailInput].forEach(function (item) {
  ...
  function handleFocusChange(e) {
    ...
    if (!__spreadArray([], parent.classList, true).includes("w-field-wrap")) parent = parent.parentElement.parentElement;
    if (isFocused) {
