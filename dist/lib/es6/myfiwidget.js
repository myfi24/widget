...
export default function createMYFIWidget(params) {
    ...
    var checkboxes = params.agreements || defaultAgreements();
    var defaultSuccessMessage = "<h2>\u0423\u0432\u0430\u0436\u0430\u0435\u043C{sextype} {partOfName},</h2> <p class=\"w-success-msg\">\n\u0412\u044B \u043F\u043E\u0434\u0430\u043B\u0438 \u0437\u0430\u044F\u0432\u043A\u0443 \u043D\u0430 \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u0438\u0435 \u043A\u0440\u0435\u0434\u0438\u0442\u0430 \u0432 \u0440\u0430\u0437\u043C\u0435\u0440\u0435 {amount} \u20BD \u043D\u0430 \u0441\u0440\u043E\u043A {term}. \u0412\u0430\u0448\u0430 \u0437\u0430\u044F\u0432\u043A\u0430 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430 \u0432:<br/> <ul>{banks}</ul> \n\u0412 \u0431\u043B\u0438\u0436\u0430\u0439\u0448\u0435\u0435 \u0432\u0440\u0435\u043C\u044F \u0441 \u0432\u0430\u043C\u0438 \u0441\u0432\u044F\u0436\u0443\u0442\u0441\u044F \u043C\u0435\u043D\u0435\u0434\u0436\u0435\u0440\u044B \u0431\u0430\u043D\u043A\u043E\u0432.</p>";
    var successMessage = params.successMessage || defaultSuccessMessage;
    ...
    (function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, onDomContentLoaded()];
                    case 1:
                        _a.sent();
                        if (!checkboxesCreated) {
                            agreementWrap_1 = document.querySelector(".w-agreement-wrap");
                            if (agreementWrap_1) {
                                checkboxes.forEach(function (checkboxInfo, index) {
                                    ...
                                    agreementWrap_1.appendChild(checkbox);
                                    agreementWrap_1.appendChild(label);
                                });
    ...
    function determineSexType(fio) {
        var femaleEndings = ['овна', 'евна', 'ична', 'ова', 'ева', 'ина', 'ая', 'яя', 'екая', 'цкая'];
        function hasEnding(word, endings) {
            return endings.some(function (ending) { return word.endsWith(ending); });
        }
        var isFemale = hasEnding(fio[1], femaleEndings) || hasEnding(fio[2], femaleEndings);
    ...
    (function () {
        return __awaiter(this, void 0, void 0, function () {
            function handleSubmit() {
                var _a, _b, _c;
                return __awaiter(this, void 0, void 0, function () {
                    var trimmedInn, values, res, detail, error_1, data, banks, fio, sexType, userNames, partOfName, amount, term, banksUl, e_1;
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            ...
                            case 4:
                                ...
                                fio = [values.first_name, values.second_name, values.last_name];
                                sexType = determineSexType(fio);
                                userNames = fio.filter(function (e) { return e; });
                                partOfName = userNames.join(" ");
                                amount = formatNumberWithSpaces(sumInput.value);
                                term = getValueWithMonths(values.term);
                                resetForm();
                                banksUl = banks
                                    .map(function (item) { return "<li class=\"w-bank-item\">".concat(item, "</li>"); })
                                    .join("");
                                wrapper.querySelector(".w-agreement-wrap").innerHTML =
                                    successMessage.replace("{partOfName}", "".concat(partOfName))
                                        .replace("{firstName}", "".concat(values.first_name))
                                        .replace("{lastName}", "".concat(values.last_name))
                                        .replace("{secondName}", "".concat(values.second_name))
                                        .replace("{amount}", "".concat(amount))
                                        .replace("{term}", "".concat(term))
                                        .replace("{banks}", "".concat(banksUl))
                                        .replace("{sextype}", "".concat(sexType));
                                wgrid.outerHTML = "";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, onDomContentLoaded()];
                    case 2:
                        _a.sent();
                        agreements = Array.from(wcontainer.querySelectorAll(".w-checkbox"));
...
//# sourceMappingURL=myfiwidget.js.map